<template>
  <div class="container">
    ...
    <div class="filter-container">
     ...
     <!-- ボタン -->
       <button class="search-button" @click="handleProgressCheck"><Finished class="icon" /> 出庫確認 </button>
      <!-- ボタン -->
      ...
      <button class="confirmed" @click="showConfirmationBox">
        <DocumentChecked class="icon" /> 出庫確定
      </button>
    </div>
    ...
    <!-- 確認モーダル -->
        ...
        <p><strong>出庫日:</strong> <span>{{ filters.arrivalDate || "未設定" }}</span></p>
