<template>
  <div class="container">
    ...
    <div class="filter-container">
      ...
      <div>
        <div class="filter-item">指定ロケ</div>
        <el-input v-model="filters.locationdata" clearable placeholder="ロケーション" />
      </div>
        ...
        didDrawCell: (data) => {
          if (data.section === 'body' && data.column.index === 4) {
            ...
            switch (data.column.index) {
              case 0:
                text = realData.syohincd || '';
                break;
              case 1:
                text = realData.syohinmei || '';
                break;
              case 2:
                text = realData.regularlocation || '';
                break;
              case 3:
                text = realData.suryo2?.toString() || '';
                break;
            }
