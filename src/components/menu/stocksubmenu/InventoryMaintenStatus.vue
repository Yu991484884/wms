        ...
        <div class="modal-body">
          ...
          <div class="field">
            ...
            <input
              id="irisu"
              type="number"
              v-model="selectedRowData.irisu1"
              class="modal-input"
              disabled
            />
          </div>
          ...
          <div class="field">
            ...
            <input
              id="locationdata"
              type="text"
              v-model="selectedRowData.locationdata"
              class="modal-input"
              disabled
            />
          </div>
          <div class="field">
            ...
            <input
              id="supplier"
              v-model="selectedRowData.sapuraiyanm"
              class="modal-input"
              disabled
            />
          </div>
...
<script setup>
  ...
  const handleProgressCheck = async () => {
    ...
    isEditButtonVisible.value = appliedDenpyokubun.value === '52' && detailsData.length > 0;
