...
const handleProgressCheck = async () => {
  ...
  try {
    // ✅ todayryuko列を'済'に更新
    await axios.post("https://www.hokuohylogi.com/tLocationTFinish/updateTodayryuko", {
    ...
    // ✅ その後、todayinデータを取得
    const response = await axios.post("https://www.hokuohylogi.com/tLocationTFinish/todayin", {
      kisandata: formattedDate,
      tokuisakicd: filters.value.tokuisaki,
      centercd: centercd
    });
